      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-5xl">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl text-center">Contact Us</h2>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
          <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Take the first step towards creating exceptional dishes. Contact us now to access the finest saffron, silver leaves, gold leaves, hing, and silver/gold coated elaichi for a truly unforgettable culinary journey.
              </p> */}
              <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
                ...
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a className="hover:text-gray-900" href="tel:+919873477849">
                      +91 987-347-7849
                    </a>
                  </dd>
                </div>
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a className="hover:text-gray-900" href="mailto:sales@shreevarnika.in">
                      sales@shreevarnika.in
                    </a>
                  </dd>
                </div>
              </dl>
