  ...
  return (
    <footer aria-labelledby="footer-heading" className="bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-20 xs:grid xl:grid-cols-5 xl:gap-4 md:grid md:grid-cols-5 md:gap-8">
          <div>
          ...
          <div className="col-span-2 md:mt-0 mt-10">
        ...
        <div className="border-t border-gray-800 py-10">
          <p className="text-sm text-gray-400">Copyright &copy; 2023 Shree Varnika Royal Products Pvt. Ltd., Inc.</p>
        </div>
      </div>
    </footer>
  )
